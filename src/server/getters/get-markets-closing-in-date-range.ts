...
export const MarketsClosingInDateRangeParams = t.intersection([MarketsClosingInDateRangeParamsSpecific, SortLimitParams]);

export async function getMarketsClosingInDateRange(db: Knex, dreamteam: {}, params: t.TypeOf<typeof MarketsClosingInDateRangeParams>): Promise<Array<Address>> {
