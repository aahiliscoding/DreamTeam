...
import { createSearchProvider } from "../../orbitdb/fts";
...
export const GetMarketsParams = t.intersection([GetMarketsParamsSpecific, SortLimitParams]);
...
export async function getMarkets(db: Knex, dreamteam: {}, params: t.TypeOf<typeof GetMarketsParams>): Promise<Array<Address>> {
