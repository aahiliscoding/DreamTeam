...
export const AccountTransferHistoryParams = t.intersection([AccountTransferHistoryParamsSpecific, SortLimitParams]);
...
export async function getAccountTransferHistory(db: Knex, dreamteam: {}, params: t.TypeOf<typeof AccountTransferHistoryParams>): Promise<Array<TransferRow<string>>> {
